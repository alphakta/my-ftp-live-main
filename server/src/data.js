...
export const dataHelpInformations = [
    ...
    { command: 'CWD <directory>', text: 'change the current directory of the server. Example : CWD ../client'},
    { command: 'RETR <filename>', text: 'transfer a copy of the file FILE from the server to the client. Example : RETR test.txt'},
    { command: 'STOR <filename>', text: 'transfer a copy of the file FILE from the client to the server. Example : STOR chat.jpg'},
